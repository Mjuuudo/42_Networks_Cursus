...
/*   Updated: 2024/05/18 18:27:45 by abait-ou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

static void	rotate_both(stack_list **a,     stack_list **b,     stack_list *cheapest_node) 
{
...
static void	rev_rotate_both(stack_list **a,   stack_list **b,   stack_list *cheapest_node) 
{
	while (cheapest_node->target_node->current_position != 0
		&& cheapest_node->current_position != 0) 
	{
...
static void	min_on_top(stack_list **a) 
{
